...
<head>
  ...
  <style>
    ...
    .alert-time svg { width: 12px; height: 12px; stroke: currentColor; fill: none; stroke-width: 2; stroke-linecap: round; stroke-linejoin: round; }
    .empty-state { text-align: center; padding: 60px 20px; color: #64748b; font-size: 14px; }
    .empty-state svg { width: 48px; height: 48px; stroke: #cbd5e1; fill: none; stroke-width: 1.5; stroke-linecap: round; stroke-linejoin: round; margin-bottom: 16px; display: block; margin-left: auto; margin-right: auto; }
    ...
    function generateAlerts() {
      ...
      if (generatedAlerts.length === 0) {
        alertsList.innerHTML = `<div class="empty-state">
          ...
          No upcoming hearings in the next 7 days.<br><br>Cases added with dates will appear here automatically.
        </div>`;
        return;
      }
...
print("Alerts module updated with professional SVGs.")
