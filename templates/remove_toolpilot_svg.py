...
if svg_badge in html:
    html = html.replace(svg_badge, '')
    with open('tools.html', 'w') as f:
        f.write(html)
    print("✅ Purple SVG badge successfully removed from tools.html.")
else:
    print("⚠️ Badge not found. It might have already been removed.")
